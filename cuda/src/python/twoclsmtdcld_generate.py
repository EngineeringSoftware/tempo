...
def generateInfo(field_references: Tuple, lang: str) -> str:
    ...
    sub_mtd_decl += buildFieldAccessExpr(field_access, SUPER_CLASS_NAME, FIELD_NAME) + " = " + getPrimVal(field_type) + ";\n"
    sub_mtd_decl += "}\n"
...
def twoClsMtdCldGenerate(input_file: str, template_file: str, input_size: int, language: str, output_dir: str, single: bool):
    if language == "cpp":
        extension: str = ".cpp"
    elif language == "cuda":
        extension: str = ".cu"
